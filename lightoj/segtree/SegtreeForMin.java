...
public class SegtreeForMin {
    ...
    public class SegmentTree {
        ...
        long OPERATION_BASE_CASE = Integer.MAX_VALUE; // FILL THIS FOR INITIALIZATION
    ...
    public static void main(String[] args) {
        ...
        SegtreeForMin ok = new SegtreeForMin();
    ...
    public void solve(InputReader in, PrintWriter w) {
        ...
        for (int i = 0; i < m; i++) {
            int[] query = in.nextIntArray(3);
            if (query[0] == 1) {
                st.set(query[1], query[2]);
            } else {
                w.println(st.calc(query[1], query[2]));
            }
        }
    }
