    ...
    public void solve(InputReader in, PrintWriter w) {
        ...
        for (int i = 0; i < m; i++) {
            ...
            if (shape.equals("rectangle")) {
                ...
                rects.add(new Rectangle(new Point(x1, y1), new Point(x2, y2)));

            } else {
                circles.add(new Circle(new Point(in.nextDouble(), in.nextDouble()), in.nextDouble()));
            }
        }
        int n = in.ii();
        for (int i = 0; i < n; i++) {
